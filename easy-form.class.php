...
class wpcf_EasyContactForm {
    ...
    public function init() {
        ...
        //default stylesheet
        $css_url = WP_PLUGIN_URL.'/contact-form-wordpress/style/default.css';
        $css_dir = WP_PLUGIN_DIR.'/contact-form-wordpress/style/default.css';
        self::include_css($css_url, $css_dir, 'wpcf_easycontact_css_default');
        
        //easy stylesheet
        $css_url = WP_PLUGIN_URL.'/contact-form-wordpress/style/easy.css';
        $css_dir = WP_PLUGIN_DIR.'/contact-form-wordpress/style/easy.css';
        self::include_css($css_url, $css_dir, 'wpcf_easycontact_css_easy');
        
        //easy js
        $default_js_url = WP_PLUGIN_URL.'/contact-form-wordpress/js/easy.js';
        $default_js_dir = WP_PLUGIN_DIR.'/contact-form-wordpress/js/easy.js';
        self::include_js($default_js_url, $default_js_dir, 'wpcf_easycontact_js_easy');
        
        //jquery-ui js
        $jquery_ui_js_url = WP_PLUGIN_URL.'/contact-form-wordpress/js/jquery-ui-1.8.10.custom.min.js';
        $jquery_ui_js_dir = WP_PLUGIN_DIR.'/contact-form-wordpress/js/jquery-ui-1.8.10.custom.min.js';
        self::include_js($jquery_ui_js_url, $jquery_ui_js_dir, 'wpcf_easycontact_js_ui');
        
        //jscolor
        $jscolor_url = WP_PLUGIN_URL.'/contact-form-wordpress/js/jscolor/jscolor.js';
        $jscolor_dir = WP_PLUGIN_DIR.'/contact-form-wordpress/js/jscolor/jscolor.js';
        self::include_js($jscolor_url, $jscolor_dir, 'wpcf_easycontact_js_color');
        
        //main js
        $main_js_url = WP_PLUGIN_URL.'/contact-form-wordpress/js/main.js';
        $main_js_dir = WP_PLUGIN_DIR.'/contact-form-wordpress/js/main.js';
